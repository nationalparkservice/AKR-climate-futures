...
SiteID <- "Kachemak-Tuxedni" #*UPDATE*
...
working.dir <- "C:/Users/arunyon/3D Objects/Local-files/RCF_Testing/Kachemak-Tuxedni/" #*UPDATE*

data.dir <- paste(working.dir, "Data", sep="/")

historical.period <- as.character(seq(1950,1999,1))
future.period <- as.character(seq(2025,2099,1))
daymet.period <- as.character(seq(1980,2016,1))

GCMs <- c("MRI-CGCM3.rcp45","CanESM2.rcp85")
