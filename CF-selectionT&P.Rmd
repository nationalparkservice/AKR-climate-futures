...
data.dir <- "D:/NCAR_AK/met/monthly/BCSD/" #*UPDATE* drive letter, if needed
vic.dir <- "D:/NCAR_AK/vic_hydro/monthly/BCSD" #*UPDATE* drive letter, if needed
...
#Updated Scatter
scatterplot(df=Deltas,X=Tmean_F,Y=Precip_in*30,title="Tmean vs Precip scatterplot",xaxis="Avg Annual Temp (F)",yaxis="Avg Annual Precip (in)") + geom_point(aes(x=mean(Tmean_F[which(paste(GCM,RCP,sep=".")==CFs[1])]), y=mean(Precip_in[which(paste(GCM,RCP,sep=".")==CFs[1])])), shape=21, size=12, stroke=3, colour=colors2[1]) +
...
#Updated Scatter
scatterplot_points(df=Deltas,X=Tmean_F,Y=Precip_in*30,title="Tmean vs Precip scatterplot",xaxis="Avg Annual Temp (F)",yaxis="Avg Annual Precip (in)") + geom_point(aes(x=mean(Tmean_F[which(paste(GCM,RCP,sep=".")==CFs[1])]), y=mean(Precip_in[which(paste(GCM,RCP,sep=".")==CFs[1])])*30), shape=21, size=12, stroke=3, colour=colors2[1]) +
  geom_point(aes(x=mean(Tmean_F[which(paste(GCM,RCP,sep=".")==CFs[2])]), y=mean(Precip_in[which(paste(GCM,RCP,sep=".")==CFs[2])])*30), shape=22, size=12, stroke=3, colour=colors2[2]) 
