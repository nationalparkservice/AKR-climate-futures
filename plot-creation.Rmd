...
df$CF <- factor(df$CF, levels = c("Historical", CFs)) # BCR added 1/30/25 to order future legends as "Historical", "Climate Future 1", and "Climate Future 2" to align better with graphical outputs
