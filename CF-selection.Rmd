...
_When running - update SiteID then go to end and select CFs after completed_
...
plot.dir <- paste0("C:/Users/achildress/Documents/wrst_temp/",SiteID) #*UPDATE*
...
CFs <- c("inmcm4.rcp85","HadGEM2-ES.rcp45","CanESM2.rcp85") #*UPDATE*
# colors2 <-  c("#6EB2D4", "#CA0020")
colors2 <- c("#12045C","#ffcccc","#E10720") #*UPDATE*
